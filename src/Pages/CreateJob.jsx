            ...
            >
                ...
                <div className="create-job-flex">
                    <div className="lg:w-1/2 w-full">
                        ...
                        <input 
                        type="url" 
                        placeholder="Paste your company URL: https://www.britannicaas.com/logo" 
                ...
                <input type="submit" className="block mb-12 bg-blue text-white font-semibold px-8 py-2 rounded-sm cursor-pointer" />
            </form>
        </div>
    </div>
  )
